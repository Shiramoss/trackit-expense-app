...
| localStorage (Web API) | אחסון מקומי  | שמירת נתוני משתמש ו-session בדפדפן |
| Web Crypto API         | אבטחה        | הצפנת סיסמאות בצד הלקוח            |
...
האפליקציה כוללת מערכת הרשמה והתחברות מלאה.  
ניתן להירשם עם אימייל וסיסמה — הנתונים נשמרים לפי משתמש ב-localStorage.  
